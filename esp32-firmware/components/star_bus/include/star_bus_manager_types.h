/* esp32-firmware/components/star_bus/include/star_bus_manager_types.h */
...
typedef struct star_bus_manager {
  ...
  error_handler_t error_handler; /**< Error handler for tracking and recovering from bus errors */
