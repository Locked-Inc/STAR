 ...
 * responding to master requests. Useful for emulating sensors or creating
 ...
 *
 * Called when master reads data from peripheral after function command.
 *
 ...
 *
 * Called when master writes data to peripheral after function command.
 *
 * @param[in] function_cmd Function command received
...
typedef struct {
  ...
  uint64_t  bytes_sent;            /**< Total bytes sent to master */
  uint64_t  bytes_received;        /**< Total bytes received from master */
