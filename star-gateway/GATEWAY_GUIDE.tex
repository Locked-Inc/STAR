% =============================================================================
% STAR Gateway Implementation Primer
% Comprehensive Guide for Spring Boot Backend on Raspberry Pi 5
% =============================================================================
...
\hypersetup{
    ...
    pdftitle={STAR Gateway Implementation Primer},
}

\definecolor{codebg}{RGB}{245,245,245}
\definecolor{codeframe}{RGB}{200,200,200}
\definecolor{kotlinkey}{RGB}{0,0,180}
\definecolor{kotlincomment}{RGB}{0,128,0}
\definecolor{kotlinstring}{RGB}{163,21,21}
...
\lstset{
    ...
    keywordstyle=\color{kotlinkey}\bfseries,
    commentstyle=\color{kotlincomment}\itshape,
    stringstyle=\color{kotlinstring},
}
...
\lstdefinelanguage{GraphQL}{
    keywords={type, input, enum, interface, union, scalar, extend, schema, query, mutation, subscription, fragment, on, implements, directive, repeatable},
    morekeywords=[2]{String, Int, Float, Boolean, ID, true, false, null},
    keywordstyle=[2]\color{kotlincomment},
    morecomment=[l]{\#},
    morestring=[b]",
    sensitive=true,
}
...
\fancyhead[R]{STAR Gateway Primer}
\fancyfoot[C]{\thepage}

\title{\textbf{STAR Gateway Implementation Primer}\\[0.5cm]
\large Kotlin/Spring Boot 3 Backend for Robot Control}
