...
**This firmware follows the STAR project code style guide.** See the main project GEMINI.md at `../GEMINI.md` for complete style guidelines.
...
**Follow the main STAR style guide** (see `../GEMINI.md`)
...
- [Main STAR Style Guide](../GEMINI.md) - Project-wide coding standards
- [ESP32 Firmware](../star-esp32-firmware/GEMINI.md) - Sister project for comparison
