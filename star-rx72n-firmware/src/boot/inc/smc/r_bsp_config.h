...
/**
 * @file r_bsp_config.h
 * @brief BSP configuration for RX72N (Smart Configurator generated)
 *
 * @details
 * Board Support Package configuration defining clocks, memory, RTOS,
 * and peripheral settings for RX72N microcontroller.
 *
 * **WARNING:** Generated by Renesas Smart Configurator - many values
 * marked "Generated value. Do not edit this manually" will be overwritten
 * if Smart Configurator regenerates this file.
 *
 * **Key Settings:**
