...
#define R_BSP_PRAGMA_STACKSIZE_SI(size)                                                            \
  static uint8_t istack_area[size] __attribute__((section(".r_bsp_istack"), used));
#define R_BSP_PRAGMA_STACKSIZE_SU(size)                                                            \
  static uint8_t ustack_area[size] __attribute__((section(".r_bsp_ustack"), used));
...
#define _R_BSP_ATTRIB_SECTION_CHANGE_B1(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(B, B##section_tag) /* The CC-RX adds postfix '_1' automatically */
#define _R_BSP_ATTRIB_SECTION_CHANGE_B2(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(B, B##section_tag) /* The CC-RX adds postfix '_2' automatically */
#define _R_BSP_ATTRIB_SECTION_CHANGE_B4(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(B, B##section_tag) /* The CC-RX does not add postfix '_4' */
#define _R_BSP_ATTRIB_SECTION_CHANGE_B8(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(B, B##section_tag) /* The CC-RX adds postfix '_8' automatically */
#define _R_BSP_ATTRIB_SECTION_CHANGE_C1(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(C, C##section_tag) /* The CC-RX adds postfix '_1' automatically */
#define _R_BSP_ATTRIB_SECTION_CHANGE_C2(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(C, C##section_tag) /* The CC-RX adds postfix '_2' automatically */
#define _R_BSP_ATTRIB_SECTION_CHANGE_C4(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(C, C##section_tag) /* The CC-RX does not add postfix '_4' */
#define _R_BSP_ATTRIB_SECTION_CHANGE_C8(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(C, C##section_tag) /* The CC-RX adds postfix '_8' automatically */
#define _R_BSP_ATTRIB_SECTION_CHANGE_D1(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(D, D##section_tag) /* The CC-RX adds postfix '_1' automatically */
#define _R_BSP_ATTRIB_SECTION_CHANGE_D2(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(D, D##section_tag) /* The CC-RX adds postfix '_2' automatically */
#define _R_BSP_ATTRIB_SECTION_CHANGE_D4(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(D, D##section_tag) /* The CC-RX does not add postfix '_4' */
#define _R_BSP_ATTRIB_SECTION_CHANGE_D8(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(D, D##section_tag) /* The CC-RX adds postfix '_8' automatically */
...
#define _R_BSP_ATTRIB_SECTION_CHANGE_B4(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(                                                                 \
    B##section_tag) /* No postfix '_4' because the CC-RX does not add it */
#define _R_BSP_ATTRIB_SECTION_CHANGE_B8(section_tag)                                               \
...
#define _R_BSP_ATTRIB_SECTION_CHANGE_C4(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(                                                                 \
    C##section_tag) /* No postfix '_4' because the CC-RX does not add it */
#define _R_BSP_ATTRIB_SECTION_CHANGE_C8(section_tag)                                               \
...
#define _R_BSP_ATTRIB_SECTION_CHANGE_D4(section_tag)                                               \
  __R_BSP_ATTRIB_SECTION_CHANGE_V(                                                                 \
    D##section_tag) /* No postfix '_4' because the CC-RX does not add it */
#define _R_BSP_ATTRIB_SECTION_CHANGE_D8(section_tag)                                               \
...
#define R_BSP_PRAGMA_STATIC_INTERRUPT(function_name, vector)                                       \
  static void function_name(void)                                                                  \
    __attribute__((interrupt(R_BSP_SECNAME_INTVECTTBL, vector), used));

#define R_BSP_PRAGMA_INTERRUPT_FUNCTION(function_name)                                             \
  extern void function_name(void) __attribute__((interrupt));
#define R_BSP_PRAGMA_STATIC_INTERRUPT_FUNCTION(function_name)                                      \
  static void function_name(void) __attribute__((interrupt, used));

#define R_BSP_ATTRIB_INTERRUPT                                                                     \
  extern /* only this one because __attribute__((interrupt)) prevents GNURX from generating vector */
#define R_BSP_ATTRIB_STATIC_INTERRUPT                                                              \
  static /* only this one because __attribute__((interrupt, used)) prevents GNURX from generating vector */
...
#define R_BSP_PRAGMA_FAST_INTERRUPT_FUNCTION(function_name)                                        \
  extern void function_name(void) __attribute__((fast_interrupt));
#define R_BSP_PRAGMA_STATIC_FAST_INTERRUPT_FUNCTION(function_name)                                 \
  static void function_name(void) __attribute__((fast_interrupt, used));
...
/* Default */
#define R_BSP_PRAGMA_INTERRUPT_DEFAULT(function_name)                                              \
  extern void function_name(void) __attribute__((interrupt(R_BSP_SECNAME_INTVECTTBL, "$default")));
#define R_BSP_PRAGMA_STATIC_INTERRUPT_DEFAULT(function_name)                                       \
  static void function_name(void)                                                                  \
    __attribute__((interrupt(R_BSP_SECNAME_INTVECTTBL, "$default"), used));
...
#define R_BSP_ATTRIB_INTERRUPT                                                                     \
  extern __interrupt /* ICCRX requires __interrupt not only at a function declaration but also at a function definition */
#define R_BSP_ATTRIB_STATIC_INTERRUPT                                                              \
  static __interrupt /* ICCRX requires __interrupt not only at a function declaration but also at a function definition */
...
#define R_BSP_ATTRIB_FAST_INTERRUPT                                                                \
  extern __fast_interrupt /* ICCRX requires __interrupt not only at a function declaration but also at a function definition */
#define R_BSP_ATTRIB_STATIC_FAST_INTERRUPT                                                         \
  static __fast_interrupt /* ICCRX requires __interrupt not only at a function declaration but also at a function definition */
...
#define R_BSP_ATTRIB_INLINE_ASM                                                                    \
  extern /* ICCRX requires __task not only at a function declaration but also at a function definition */
#define R_BSP_ATTRIB_STATIC_INLINE_ASM                                                             \
  static /* ICCRX requires __task not only at a function declaration but also at a function definition */
