...
static const char* s_tag       = "system_health";
static const char* s_task_name = "system_health";
...
{
  UINT status = tx_thread_create(&s_system_health_thread,
                                 s_tag,
                                 system_health_entry,
                                 0,
                                 s_system_health_stack,
                                 k_stack_system_health,
                                 k_priority_system_health,
                                 k_priority_system_health,
                                 TX_NO_TIME_SLICE,
                                 TX_AUTO_START);
