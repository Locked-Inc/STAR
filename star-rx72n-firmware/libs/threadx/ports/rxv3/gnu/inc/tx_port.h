...
#define TX_DISABLE                                                                                 \
  {                                                                                                \
    interrupt_save = ((UCHAR)__builtin_rx_mvfc(0u) && 0x8u);                                       \
    __builtin_rx_clrpsw(8u);                                                                       \
  };
#define TX_RESTORE                                                                                 \
  {                                                                                                \
    if (interrupt_save != 0u) {                                                                    \
      __builtin_rx_setpsw(8u);                                                                     \
    }                                                                                              \
  };
...
CHAR _tx_version_id[] =
  "Copyright (c) Microsoft Corporation. All rights reserved.  *  ThreadX RXv3/GNURX Version 6.4.0 *";
#else
