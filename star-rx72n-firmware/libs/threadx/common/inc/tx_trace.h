...
typedef struct TX_TRACE_OBJECT_ENTRY_STRUCT {
  ...
  UCHAR tx_trace_object_entry_name
    [TX_TRACE_OBJECT_REGISTRY_NAME]; /* Object name                          */
...
#define TX_TRACE_ISR_ENTER                                                                         \
  3 /* I1 = stack_ptr, I2 = ISR number, I3 = system state, I4 = preempt disable */
#define TX_TRACE_ISR_EXIT                                                                          \
  4 /* I1 = stack_ptr, I2 = ISR number, I3 = system state, I4 = preempt disable */
#define TX_TRACE_TIME_SLICE                                                                        \
  5 /* I1 = next thread ptr, I2 = system state, I3 = preempt disable, I4 = stack*/
...
#define TX_TRACE_BLOCK_ALLOCATE                                                                    \
  10 /* I1 = pool ptr, I2 = memory ptr, I3 = wait option, I4 = remaining blocks  */
...
#define TX_TRACE_EVENT_FLAGS_CREATE                                                                \
  30 /* I1 = group ptr, I2 = stack ptr                                           */
#define TX_TRACE_EVENT_FLAGS_DELETE                                                                \
  31 /* I1 = group ptr, I2 = stack ptr                                           */
#define TX_TRACE_EVENT_FLAGS_GET                                                                   \
  32 /* I1 = group ptr, I2 = requested flags, I3 = current flags, I4 = get option*/
...
#define TX_TRACE_EVENT_FLAGS_SET                                                                   \
  36 /* I1 = group ptr, I2 = flags to set, I3 = set option, I4= suspended count  */
...
#define TX_TRACE_QUEUE_DELETE                                                                      \
  61 /* I1 = queue ptr, I2 = stack ptr                                           */
#define TX_TRACE_QUEUE_FLUSH                                                                       \
  62 /* I1 = queue ptr, I2 = stack ptr                                           */
...
#define TX_TRACE_QUEUE_SEND_NOTIFY                                                                 \
  70 /* I1 = queue ptr                                                           */
...
#define TX_TRACE_SEMAPHORE_DELETE                                                                  \
  82 /* I1 = semaphore ptr, I2 = stack ptr                                       */
#define TX_TRACE_SEMAPHORE_GET                                                                     \
  83 /* I1 = semaphore ptr, I2 = wait option, I3 = current count, I4 = stack ptr */
...
#define TX_TRACE_SEMAPHORE_PUT                                                                     \
  88 /* I1 = semaphore ptr, I2 = current count, I3 = suspended count,I4=stack ptr*/
...
#define TX_TRACE_THREAD_DELETE                                                                     \
  101 /* I1 = thread ptr, I2 = stack ptr                                          */
...
#define TX_TRACE_THREAD_INFO_GET                                                                   \
  104 /* I1 = thread ptr, I2 = thread state                                       */
...
#define TX_TRACE_THREAD_RESET                                                                      \
  110 /* I1 = thread ptr, I2 = thread state                                       */
...
#define TX_TRACE_TIME_GET                                                                          \
  120 /* I1 = current time, I2 = stack ptr                                        */
...
#define TX_TRACE_TIMER_DEACTIVATE                                                                  \
  125 /* I1 = timer ptr, I2 = stack ptr                                           */
#define TX_TRACE_TIMER_DELETE                                                                      \
  126 /* I1 = timer ptr                                                           */
#define TX_TRACE_TIMER_INFO_GET                                                                    \
  127 /* I1 = timer ptr, I2 = stack ptr                                           */
...
VOID _tx_trace_object_register(UCHAR object_type,
                               VOID* object_ptr,
                               CHAR* object_name,
                               ULONG parameter_1,
                               ULONG parameter_2);
