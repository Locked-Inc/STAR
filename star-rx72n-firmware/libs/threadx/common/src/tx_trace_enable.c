...
UINT _tx_trace_enable(VOID* trace_buffer_start, ULONG trace_buffer_size, ULONG registry_entries)
{
  ...
  if (trace_buffer_size <
      ((sizeof(TX_TRACE_HEADER)) + ((sizeof(TX_TRACE_OBJECT_ENTRY)) * registry_entries) +
  ...
  /* Determine if trace is already enabled.  */
    ...
    trace_buffer_size = trace_buffer_size - ((sizeof(TX_TRACE_OBJECT_ENTRY)) * registry_entries) -
                        (sizeof(TX_TRACE_HEADER));
    ...
    work_ptr = TX_UCHAR_POINTER_ADD(
      work_ptr,
      ((trace_buffer_size / (sizeof(TX_TRACE_BUFFER_ENTRY))) * (sizeof(TX_TRACE_BUFFER_ENTRY))));
    ...
    _tx_trace_header_ptr->tx_trace_header_trace_base_address =
      TX_POINTER_TO_ULONG_CONVERT(trace_buffer_start);
    _tx_trace_header_ptr->tx_trace_header_registry_start_pointer =
      TX_POINTER_TO_ULONG_CONVERT(_tx_trace_registry_start_ptr);
    _tx_trace_header_ptr->tx_trace_header_reserved1 = ((USHORT)0);
    _tx_trace_header_ptr->tx_trace_header_object_name_size =
      ((USHORT)TX_TRACE_OBJECT_REGISTRY_NAME);
    _tx_trace_header_ptr->tx_trace_header_registry_end_pointer =
      TX_POINTER_TO_ULONG_CONVERT(_tx_trace_registry_end_ptr);
    _tx_trace_header_ptr->tx_trace_header_buffer_start_pointer =
      TX_POINTER_TO_ULONG_CONVERT(_tx_trace_buffer_start_ptr);
    _tx_trace_header_ptr->tx_trace_header_buffer_end_pointer =
      TX_POINTER_TO_ULONG_CONVERT(_tx_trace_buffer_end_ptr);
    ...
    while (i != ((ULONG)0)) {
      ...
      _tx_trace_object_register(TX_TRACE_OBJECT_TYPE_THREAD,
                                thread_ptr,
                                thread_ptr->tx_thread_name,
                                TX_POINTER_TO_ULONG_CONVERT(thread_ptr->tx_thread_stack_start),
                                (ULONG)thread_ptr->tx_thread_stack_size);
    ...
    while (i != ((ULONG)0)) {
      ...
      /* Register this timer.  */
      _tx_trace_object_register(TX_TRACE_OBJECT_TYPE_TIMER,
                                timer_ptr,
                                timer_ptr->tx_timer_name,
                                ((ULONG)0),
    ...
    while (i != ((ULONG)0)) {
      ...
      _tx_trace_object_register(TX_TRACE_OBJECT_TYPE_EVENT_FLAGS,
                                event_flags_ptr,
    ...
    while (i != ((ULONG)0)) {
      ...
      /* Register this queue.  */
      _tx_trace_object_register(TX_TRACE_OBJECT_TYPE_QUEUE,
                                queue_ptr,
                                queue_ptr->tx_queue_name,
                                (queue_ptr->tx_queue_capacity * (sizeof(ULONG))),
                                ((ULONG)0));
    ...
    while (i != ((ULONG)0)) {
      ...
      _tx_trace_object_register(TX_TRACE_OBJECT_TYPE_SEMAPHORE,
                                semaphore_ptr,
    ...
    while (i != ((ULONG)0)) {
      ...
      /* Register this mutex.  */
      _tx_trace_object_register(TX_TRACE_OBJECT_TYPE_MUTEX,
                                mutex_ptr,
                                mutex_ptr->tx_mutex_name,
                                (ULONG)mutex_ptr->tx_mutex_inherit,
                                ((ULONG)0));
    ...
    while (i != ((ULONG)0)) {
      ...
      _tx_trace_object_register(TX_TRACE_OBJECT_TYPE_BLOCK_POOL,
                                block_pool_ptr,
                                block_pool_ptr->tx_block_pool_name,
                                block_pool_ptr->tx_block_pool_size,
                                ((ULONG)0));
    ...
    while (i != ((ULONG)0)) {
      ...
      _tx_trace_object_register(TX_TRACE_OBJECT_TYPE_BYTE_POOL,
                                byte_pool_ptr,
                                byte_pool_ptr->tx_byte_pool_name,
                                byte_pool_ptr->tx_byte_pool_size,
                                ((ULONG)0));
