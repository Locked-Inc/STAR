 ...
 *
 * @par Current Sensing (DRV8263H-Q1 IPROPI)
 ...
 * - **Conversion**: I_motor = V_IPROPI / 1.0302
 * - **Derivation**: V_IPROPI = I_motor * 202e-6 * 5100 = I_motor * 1.0302
 *
 * Example: V_IPROPI = 1.65V (mid-scale):
 * @f[
 * I_{motor} = \frac{1.65}{1.0302} = 1.602 A
 * @f]
 *
