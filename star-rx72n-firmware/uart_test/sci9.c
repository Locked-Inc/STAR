/**
 * @file sci9_debug.c
 * @brief Minimal polled-mode SCI9 (TXD9 = PB7, RXD9 = PB6) debug UART for uart_test.
 *
 * @details
...
{
    /* Step 1: release SCI9 from module stop. SCI9 lives at MSTPCRC bit 26
     * (NOT MSTPCRB.bit22 -- that's PDC). PRC1 unlock gates MSTPCR* writes. */
