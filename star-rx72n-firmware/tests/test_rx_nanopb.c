...
void test_create_velocity_command_null(void)
{
    ...
    rx_nanopb_create_velocity_command(NULL, s_test_left_velocity_mps,
                                      s_test_right_velocity_mps, k_test_sequence_number);
...
void test_create_velocity_command_valid(void)
{
    ...
    rx_nanopb_create_velocity_command(&cmd, s_test_left_velocity_mps,
                                      s_test_right_velocity_mps, k_test_sequence_number);

    TEST_ASSERT_FLOAT_WITHIN(s_test_float_tolerance, (float)s_test_left_velocity_mps, (float)cmd.left_velocity_mps);
    TEST_ASSERT_FLOAT_WITHIN(s_test_float_tolerance, (float)s_test_right_velocity_mps, (float)cmd.right_velocity_mps);
...
{
    star_v1_VelocityCommand cmd;
    rx_nanopb_create_velocity_command(&cmd, s_test_zero_velocity_mps,
                                      s_test_zero_velocity_mps, 0);

    TEST_ASSERT_FLOAT_WITHIN(s_test_float_tolerance, (float)s_test_zero_velocity_mps, (float)cmd.left_velocity_mps);
    TEST_ASSERT_FLOAT_WITHIN(s_test_float_tolerance, (float)s_test_zero_velocity_mps, (float)cmd.right_velocity_mps);
...
void test_create_velocity_command_max_sequence(void)
{
    star_v1_VelocityCommand cmd;
    rx_nanopb_create_velocity_command(&cmd, s_test_left_velocity_mps,
                                      s_test_right_velocity_mps, k_test_sequence_max);
