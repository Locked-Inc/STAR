...
{
  mock_usb_hw_set_attach_return(NULL, k_rx_err_busy);
...
void test_cleanup_on_attach_failure(void)
{
  ...
  TEST_ASSERT_EQUAL_UINT32(1, mock_usb_hw_get_call_count(NULL, "rx_usb_hw_deinit"));
}
...
void test_pipe_bounds_validation_at_max(void)
{
  ...
  TEST_ASSERT_EQUAL_UINT32(1, mock_usb_hw_get_call_count(NULL, "rx_usb_hw_init"));
}
...
void test_endpoint_bounds_max_valid(void)
{
  ...
  TEST_ASSERT_EQUAL_UINT32(1, mock_usb_hw_get_call_count(NULL, "rx_usb_cdc_init"));
}
