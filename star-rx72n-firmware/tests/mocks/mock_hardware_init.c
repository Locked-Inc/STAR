/* star-rx72n-firmware/tests/mocks/mock_hardware_init.c */

/**
 * @file mock_hardware_init.c
 * @brief Mock Hardware Initialization Implementation
 *
 * @details
 * Implements mock hardware_init() for unit testing.
...
/** @brief Configured return value for hardware_init() */
static rx_err_t s_return_value = k_rx_ok;

/** @brief Number of times hardware_init() was called */
...
/**
 * @brief Mock hardware_init() - replaces real implementation for testing
 *
