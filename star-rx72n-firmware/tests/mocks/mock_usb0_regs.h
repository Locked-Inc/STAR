/* star-rx72n-firmware/tests/mocks/mock_usb0_regs.h */
...
/**
 * @note Register layout corrected 2026-01-28 to match RX72N manual Ch40.
 * Removed non-existent registers: BUSWAIT, PLLSTA, TESTMODE, D0FBCFG, D1FBCFG,
...
typedef struct {
  ...
  uint16_t dvchgr;  /* 0x4E: Device State Change (NOT ufrmnum!) */
...
/**
 * @brief Set any pipe busy status
 *
 * @param pipe Pipe number (1-9)
 * @param busy True to set PBUSY bit, false to clear
 */
