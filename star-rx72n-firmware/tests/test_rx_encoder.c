...
#include "../libs/rx_encoder/src/rx_mtu_encoder.c"
...
void test_encoder_read_velocity_null_pointer_fails(void)
{
  ...
  rx_err_t err = rx_encoder_read_velocity(nullptr, 0.01f, s_config.channel);
...
void test_encoder_set_count_updates_hardware_counter(void)
{
  ...
  TEST_ASSERT_EQUAL(k_rx_ok, rx_encoder_set_count(1234, s_config.channel));
