 ...
 *
 * Implements IEEE 802.3 CRC-32 using a precomputed lookup table.
 * Used for host-side testing and as a fallback for incremental CRC
 * when hardware CRC is used for single-shot calculations.
 *
 * Algorithm:
