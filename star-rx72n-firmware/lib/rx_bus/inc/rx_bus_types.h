...
typedef struct rx_bus_config {
  ...
  union {
    rx_gpio_bus_config_t    gpio;    /**< GPIO configuration */
    rx_adc_bus_config_t     adc;     /**< ADC configuration */
    rx_i2c_bus_config_t     i2c;     /**< I2C configuration */
    rx_smbus_bus_config_t   smbus;   /**< SMBUS configuration */
    rx_spi_bus_config_t     spi;     /**< SPI configuration */
    rx_uart_bus_config_t    uart;    /**< UART configuration */
    rx_onewire_bus_config_t onewire; /**< 1-Wire configuration */
  } proto;
 ...
 */
#ifdef __cplusplus
inline constexpr uint16_t k_bus_manager_mutex_timeout_ms = 1000U; /**< Default mutex timeout (ms) */
#else
static const uint16_t k_bus_manager_mutex_timeout_ms = 1000U; /**< Default mutex timeout (ms) */
#endif
