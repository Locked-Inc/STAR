...
typedef enum : uint8_t {
    ...
    k_mstpb_sci9_bit   = 22U,
    k_pwpr_unlock_b0   = 0x00U,
    k_pwpr_pfswe       = 0x40U,
    k_pwpr_b0wi        = 0x80U,
    k_brr_115200_60mhz = 15U,
...
{
    /* Step 1: release SCI9 from module stop (PRC1 controls MSTPCR). */
    *prcr_reg() = k_rx_prcr_unlock_prc0_prc1;
    system_regs()->mstpcrb &= ~(uint32_t)(1UL << (uint32_t)k_mstpb_sci9_bit);
