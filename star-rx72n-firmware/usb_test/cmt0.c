/**
 * @file cmt0.c
 * @brief CMT0 100 Hz tick source for ThreadX with PCKB = 60 MHz.
 *
 * After clock_init() PCKB = 60 MHz.  PCKB/32 = 1.875 MHz, divided by 18750
 * = 100 Hz exactly.  CMCOR = 18749, CMCR.CKS = 01 (PCKB/32), CMIE = 1.
 *
...
/* ==========================================================================
 * CMT0 configuration (PCKB = 60 MHz)
 * ========================================================================== */
