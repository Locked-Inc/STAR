...
\includegraphics[width=5.5in]{Locked Inc LOGO trans.png}

\vspace{0.2in}

% Decorative line
{\color{brandcolor}\rule{\textwidth}{3pt}}

\vspace{0.3in}

{\LARGE \textbf{Texas A\&M University}}\\[0.2in]
{\large Department of Engineering Technology and Industrial Distribution}\\[0.1in]
% {\large Course Number: Senior Design Project}

\vspace{0.4in}

% Project Title
{\fontsize{28}{34}\selectfont \textbf{\textcolor{brandcolor}{STAR Autonomous Mapping Robot}}}
...
% Decorative line
{\color{brandcolor}\rule{0.5\textwidth}{1.5pt}}
...
% Sponsor
{\large \textbf{Sponsor:} Dr. Logan Porter}\\[0.1in]
{\large \textbf{Technical Advisor:} Dr. Logan Porter}\\[0.1in]
...
% 5/12 This has been reviewed - Brighton
Locked Inc. is completely committed to finishing this project on time and within budget. Locked Inc. will retain all intellectual property for the STAR Robot. See \cref{sec:ip-statement} for details.
