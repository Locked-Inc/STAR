...
\textbf{Go Compatibility:} Both implementations produce bit-exact results matching Go's \texttt{crc32.ChecksumIEEE()}, verified by 18 unit tests including the canonical test vector ``123456789'' = \texttt{0xCBF43926}.
