...
The protocol uses little-endian byte ordering for all multi-byte fields, matching the native byte order of both the RX72N (little-endian ARM core) and Raspberry Pi 5 (ARM little-endian). This eliminates byte-swapping overhead on both platforms.
