...
\begin{itemize}[leftmargin=*,topsep=2pt,itemsep=1pt]
    ...
    \item \textbf{HARQ soft buffers (3x):} $3 \times 1024 \times 16 = 49152\text{ bytes} \approx 48.0\text{ KB}$ \\
          \textit{Calculation:} 3 combining buffers $\times$ 1024B max payload $\times$ 16 soft bits/byte (rate 1/2 FEC, 8 input bits) \\
          \textit{Usage:} $\frac{48.0}{512} \times 100 = 9.38\%$

    \item \textbf{Viterbi decoder:} $64 \times 2 + 35 \times 8 = 408\text{ bytes} \approx 3.0\text{ KB}$ \\
          \textit{Calculation:} 64-state path metrics (128B) + traceback survivors (280B) + working buffers \\
