...
The USB CDC protocol is designed for minimal overhead, relying on USB hardware for reliability. Unlike the SPI path which uses full HARQ (ARQ + FEC) and retransmission, the CDC path omits these as redundant with USB's built-in CRC and retry mechanisms.
