...
\begin{lstlisting}[language = C] void set_flag(void) {
...
\begin{lstlisting}[language = C] int add(int a, int b) {
  int result;
...
\begin{lstlisting}[language = C] rx_err_t star_bus_manager_add_bus(
...
Generated C code :
\begin{lstlisting}[language = C] typedef struct _RequestHeader {
...
Generated C code :
\begin{lstlisting}[language = C] typedef struct _BatteryState {
...
Generated C code :
\begin{lstlisting}[language = C] typedef struct _FirmwareChunk {
