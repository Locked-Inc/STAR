...
if (motor_temp_celsius > MOTOR_THERMAL_SHUTDOWN_CELSIUS) {
      star_drv8263_stop(&motor, true); /* Emergency brake */
}
...
star_drv8263_read_current(&motor, &motor_current_ma);
...
if (motor_current_ma > MAX_MOTOR_CURRENT_MA) {
      ...
      star_drv8263_set_speed(&motor, 0.0f);
}
...
star_drv8263_set_speed(&motor, duty_cycle_percent);
...
void system_enter_safe_mode(void)
{
      ...
      for (int i = 0; i < NUM_MOTORS; i++) {
        star_drv8263_stop(&motors[i], true); /* Brake */
     }
