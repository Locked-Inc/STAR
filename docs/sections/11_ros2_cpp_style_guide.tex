...
label={lst:namespace}] namespace star { namespace spi_bridge {
...
label={lst:include_guard}] #ifndef
STAR_GATEWAY_BRIDGE_STAR_GATEWAY_BRIDGE_NODE_HPP_ #define
STAR_GATEWAY_BRIDGE_STAR_GATEWAY_BRIDGE_NODE_HPP_
...
label={lst:indentation}] class MyNode : public rclcpp::Node { public: MyNode() :
...
label={lst:pub_sub}] class MyNode : public rclcpp::Node { public: MyNode() :
Node("my_node") {
