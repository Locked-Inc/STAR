...
\subsection{Layer 8: UI tests}

\textbf{Where:} \texttt{star-ui/src/test/}.
\textbf{Framework:} Vitest + React Testing Library.
\textbf{Run:} \texttt{cd star-ui \&\& npm test}.

\subsection{Layer 9: Static analysis}
