...
\hline
\textcolor{green}{\textbf{✓ COMPLIANT}} & STAR follows this rule \\
\hline
\textcolor{orange}{\textbf{⚠ INTENTIONAL DEVIATION}} & Architectural choice (DIP pattern) \\
\hline
\end{tabular}
\end{table}
...
\textbf{STAR Compliance:} \textcolor{green}{\textbf{✓ COMPLIANT}}
...
\textbf{STAR Compliance:} \textcolor{green}{\textbf{✓ MOSTLY COMPLIANT}}
...
\textbf{STAR Compliance:} \textcolor{orange}{\textbf{⚠ INTENTIONAL DEVIATION}}
...
\hline
1 & No \texttt{goto}/recursion & \textcolor{green}{✓ COMPLIANT} \\
\hline
2 & Fixed loop bounds & \textcolor{green}{✓ COMPLIANT} \\
\hline
3 & No dynamic memory & \textcolor{green}{✓ COMPLIANT} \\
\hline
4 & Short functions ($<$60 lines) & \textcolor{green}{✓ COMPLIANT} \\
\hline
5 & Use assertions & \textcolor{green}{✓ COMPLIANT} \\
\hline
6 & Minimal variable scope & \textcolor{green}{✓ COMPLIANT} \\
\hline
7 & Check all returns & \textcolor{green}{✓ COMPLIANT} \\
\hline
8 & Limit preprocessor & \textcolor{green}{✓ COMPLIANT} \\
\hline
9 & Restrict pointers & \textcolor{orange}{⚠ INTENTIONAL (DIP)} \\
\hline
10 & Maximum warnings & \textcolor{green}{✓ COMPLIANT} \\
\hline
\end{tabular}
\end{table}
