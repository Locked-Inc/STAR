...
\texttt{star-ui/}                    & Vite (\texttt{npm install \&\& npm run build}).                                                                                  \\
...
\texttt{proto.yml}                         & buf format / lint / build / breaking, regen Go/TypeScript/nanopb, round-trip serialization tests.                                \\
