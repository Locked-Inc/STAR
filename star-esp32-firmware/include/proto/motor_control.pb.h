...
#define star_v1_VelocityCommand_init_default     {0, 0, 0, 0}
...
#define star_v1_VelocityCommand_init_zero        {0, 0, 0, 0}
...
#define star_v1_VelocityCommand_left_velocity_mps_tag 1
#define star_v1_VelocityCommand_right_velocity_mps_tag 2
...
X(a, STATIC,   SINGULAR, DOUBLE,   left_velocity_mps,   1) \
X(a, STATIC,   SINGULAR, DOUBLE,   right_velocity_mps,   2) \
...
#define star_v1_SetVelocityRequest_size          (43 + star_v1_RequestHeader_size)
...
#define star_v1_VelocityCommand_size             35
