/* lib/star_bus/include/star_bus_helpers.h */
 ...
 * gpio_num_t copi = GPIO_NUM_23;
 * if (!star_bus_validate_gpio_spi(copi)) {
 ...
 * // COPI: STAR_BUS_SPI_DEFAULT_COPI (GPIO 23)
 * // CIPO: STAR_BUS_SPI_DEFAULT_CIPO (GPIO 19)
...
/**
 * @brief Quick setup: I2C controller with automatic defaults
 *
