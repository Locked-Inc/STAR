/* lib/star_bus/include/star_bus_smbus_peripheral.h */
 ...
 * responding to controller requests. Useful for emulating SMBus devices
 ...
 * Example:
 * @code
 * // Read callback - controller reading register
 ...
 *
 * Pulls SMBALERT# line low to signal controller.
 *
 * @param[in] manager Pointer to initialized bus manager
 * @param[in] bus_name Name of I2C/SMBus bus
 *
