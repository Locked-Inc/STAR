 ...
 * to controller requests. It provides a flexible callback-based interface for
 ...
 * - Testing I2C controller implementations
 * - Multi-controller I2C systems
 *
 * Example:
 * @code
 * // Peripheral read callback - controller is reading from us
 ...
 * }
 *
 * // Peripheral write callback - controller is writing to us
 ...
 *
 * Called when controller requests data from peripheral.
 *
 ...
 *
 * @note If error is returned, NACK will be sent to controller
 ...
 *
 * Called when controller sends data to peripheral.
 *
...
typedef struct {
  ...
  uint64_t  total_bytes_sent;     /**< Total bytes sent to controller */
  uint64_t  total_bytes_received; /**< Total bytes received from controller */
 ...
 * The bus cannot be used for controller operations while in peripheral mode.
 *
 ...
 *
 * Retrieves the most recent data written by controller.
 *
 * @param[in]  manager Pointer to initialized bus manager
 * @param[in]  bus_name Name of I2C bus
