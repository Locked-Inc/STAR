% =============================================================================
% STAR Proto Implementation Primer
% Comprehensive Guide for Protocol Buffer Definitions
% =============================================================================
...
\hypersetup{
    ...
    pdftitle={STAR Proto Implementation Primer},
}
...
\lstdefinelanguage{Protobuf}{
    keywords={syntax, package, option, import, message, enum, service, rpc, returns, stream, repeated, optional, required, map, oneof, reserved, extend, extensions, to, max},
    morekeywords=[2]{double, float, int32, int64, uint32, uint64, sint32, sint64, fixed32, fixed64, sfixed32, sfixed64, bool, string, bytes},
...
\lstdefinelanguage{Kotlin}{
    keywords={fun, val, var, class, object, interface, return, if, else, when, for, while, suspend, async, override, private, public, data, sealed, enum, import, package},
    morecomment=[l]{//},
    morecomment=[s]{/*}{*/},
    morestring=[b]",
    sensitive=true,
...
\fancyhead[R]{STAR Proto Primer}
\fancyfoot[C]{\thepage}

\title{\textbf{STAR Proto Implementation Primer}\\[0.5cm]
\large Shared Protocol Buffer Definitions}
