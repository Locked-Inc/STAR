...
for pattern in "/dev/ttyPS*" "/dev/ttyS*" "/dev/ttyUSB*" "/dev/ttyACM*"; do
...
echo "============================================================"
echo ""
echo "ttyPS* = Zynq PS UART (ARM processor built-in UART)"
echo "  ttyPS0 = Usually system console"
echo "  ttyPS1 = May be available for 40-pin header"
echo ""
echo "ttyUSB* = USB-UART adapters (FTDI, etc.)"
echo "  ttyUSB0 = Your FTDI adapter"
echo ""
echo "For 40-pin header (pins 8, 10):"
echo "  These are typically mapped to ttyPS1 or ttyS1"
...
echo "============================================================"
echo ""
echo "If ttyPS1 exists and is NOT console:"
echo "  -> Use this for 40-pin header UART"
echo ""
echo "If ttyPS1 does NOT exist:"
