...
public:
   ...
   * @since Version 1.0.0
   */
  void telemetry_to_obstacle_ranges(const star::v1::TelemetryData & telemetry, sensor_msgs::msg::Range & front_left,
                                    sensor_msgs::msg::Range & front_right, sensor_msgs::msg::Range & back_left,
