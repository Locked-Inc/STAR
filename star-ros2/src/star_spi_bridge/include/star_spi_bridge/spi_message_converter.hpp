#ifndef STAR_SPI_BRIDGE_SPI_MESSAGE_CONVERTER_HPP_
#define STAR_SPI_BRIDGE_SPI_MESSAGE_CONVERTER_HPP_
...
public:
    ...
    void telemetry_to_battery_state(const star::v1::TelemetryData& telemetry, sensor_msgs::msg::BatteryState& battery_state);
...
#endif // STAR_SPI_BRIDGE_SPI_MESSAGE_CONVERTER_HPP_
