...
: ${AMENT_CURRENT_PREFIX:="/workspaces/STAR/star-ros2/install/star_safety_monitor"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/star_safety_monitor/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/star_safety_monitor/environment/path.sh"
