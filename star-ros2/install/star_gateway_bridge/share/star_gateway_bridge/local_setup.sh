...
: ${AMENT_CURRENT_PREFIX:="/workspaces/STAR/star-ros2/install/star_gateway_bridge"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/star_gateway_bridge/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/star_gateway_bridge/environment/path.sh"
