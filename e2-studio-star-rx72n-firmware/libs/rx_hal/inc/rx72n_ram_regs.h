...
static_assert(sizeof(rx_ram_regs_t) == 12,
    "rx_ram_regs_t size must be 12 bytes");
static_assert(offsetof(rx_ram_regs_t, rammode) == 0x00,
    "RAMMODE offset must be 0x00");
static_assert(offsetof(rx_ram_regs_t, ramsts) == 0x01,
    "RAMSTS offset must be 0x01");
static_assert(offsetof(rx_ram_regs_t, ramprcr) == 0x04,
    "RAMPRCR offset must be 0x04");
static_assert(offsetof(rx_ram_regs_t, ramecad) == 0x08,
    "RAMECAD offset must be 0x08");

/* Expansion RAM register structure size and offset verification */
static_assert(sizeof(rx_exram_regs_t) == 12,
    "rx_exram_regs_t size must be 12 bytes");
static_assert(offsetof(rx_exram_regs_t, exrammode) == 0x00,
    "EXRAMMODE offset must be 0x00");
static_assert(offsetof(rx_exram_regs_t, exramsts) == 0x01,
    "EXRAMSTS offset must be 0x01");
static_assert(offsetof(rx_exram_regs_t, exramprcr) == 0x04,
    "EXRAMPRCR offset must be 0x04");
static_assert(offsetof(rx_exram_regs_t, exramecad) == 0x08,
    "EXRAMECAD offset must be 0x08");
...
static_assert(offsetof(rx_eccram_regs_t, eccrammode) == 0x00,
    "ECCRAMMODE offset must be 0x00");
static_assert(offsetof(rx_eccram_regs_t, eccram2sts) == 0x01,
    "ECCRAM2STS offset must be 0x01");
static_assert(offsetof(rx_eccram_regs_t, eccram1stsen) == 0x02,
    "ECCRAM1STSEN offset must be 0x02");
static_assert(offsetof(rx_eccram_regs_t, eccram1sts) == 0x03,
    "ECCRAM1STS offset must be 0x03");
static_assert(offsetof(rx_eccram_regs_t, eccramprcr) == 0x04,
    "ECCRAMPRCR offset must be 0x04");
static_assert(offsetof(rx_eccram_regs_t, eccram2ecad) == 0x08,
    "ECCRAM2ECAD offset must be 0x08");
static_assert(offsetof(rx_eccram_regs_t, eccram1ecad) == 0x0C,
    "ECCRAM1ECAD offset must be 0x0C");
static_assert(offsetof(rx_eccram_regs_t, eccramprcr2) == 0x10,
    "ECCRAMPRCR2 offset must be 0x10");
static_assert(offsetof(rx_eccram_regs_t, eccrametst) == 0x14,
    "ECCRAMETST offset must be 0x14");

/* Base address verification */
static_assert(k_rx_ram_reg_base_addr == 0x00081200,
    "RAM register base must be 0x00081200");
...
static_assert(k_rx_eccram_reg_base_addr == 0x000812C0,
    "ECCRAM register base must be 0x000812C0");

/* Memory region verification */
static_assert(k_rx_ram_base_addr == 0x00000000,
    "RAM base must be 0x00000000");
static_assert(k_rx_ram_size == 0x00080000,
    "RAM size must be 512 KB (0x80000)");
static_assert(k_rx_exram_base_addr == 0x00800000,
    "Expansion RAM base must be 0x00800000");
static_assert(k_rx_exram_size == 0x00080000,
    "Expansion RAM size must be 512 KB (0x80000)");
static_assert(k_rx_eccram_base_addr == 0x00FF8000,
    "ECCRAM base must be 0x00FF8000");
static_assert(k_rx_eccram_size == 0x00008000,
    "ECCRAM size must be 32 KB (0x8000)");

/* Protection register key values */
static_assert(k_rx_ramprcr_unlock == 0x79,
    "RAMPRCR unlock value must be 0x79");
static_assert(k_rx_exramprcr_unlock == 0x79,
    "EXRAMPRCR unlock value must be 0x79");
static_assert(k_rx_eccramprcr_unlock == 0x79,
    "ECCRAMPRCR unlock value must be 0x79");
