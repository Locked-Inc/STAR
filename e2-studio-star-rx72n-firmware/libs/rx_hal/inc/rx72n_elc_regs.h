...
/* Verify ELCR address */
static_assert(k_elc_elcr_addr == 0x0008B100U,
               "ELCR address must be 0x0008B100 per Ch21 manual");

/* Verify ELSRn addresses */
static_assert(k_elc_elsr0_addr == 0x0008B101U,
               "ELSR0 address must be 0x0008B101 per Ch21 manual");

static_assert(k_elc_elsr3_addr == 0x0008B104U,
               "ELSR3 address must be 0x0008B104 per Ch21 manual");

static_assert(k_elc_elsr4_addr == 0x0008B105U,
               "ELSR4 address must be 0x0008B105 per Ch21 manual");
...
static_assert(k_elc_elopa_addr == 0x0008B11FU,
               "ELOPA address must be 0x0008B11F per Ch21 manual");

static_assert(k_elc_elopb_addr == 0x0008B120U,
               "ELOPB address must be 0x0008B120 per Ch21 manual");

static_assert(k_elc_elopc_addr == 0x0008B121U,
               "ELOPC address must be 0x0008B121 per Ch21 manual");

static_assert(k_elc_elopd_addr == 0x0008B122U,
               "ELOPD address must be 0x0008B122 per Ch21 manual");

static_assert(k_elc_elopf_addr == 0x0008B13FU,
               "ELOPF address must be 0x0008B13F per Ch21 manual");

static_assert(k_elc_eloph_addr == 0x0008B141U,
               "ELOPH address must be 0x0008B141 per Ch21 manual");

/* Verify port event register addresses */
static_assert(k_elc_pgr1_addr == 0x0008B123U,
               "PGR1 address must be 0x0008B123 per Ch21 manual");

static_assert(k_elc_pgr2_addr == 0x0008B124U,
               "PGR2 address must be 0x0008B124 per Ch21 manual");

static_assert(k_elc_pgc1_addr == 0x0008B125U,
               "PGC1 address must be 0x0008B125 per Ch21 manual");

static_assert(k_elc_pgc2_addr == 0x0008B126U,
               "PGC2 address must be 0x0008B126 per Ch21 manual");

static_assert(k_elc_pdbf1_addr == 0x0008B127U,
               "PDBF1 address must be 0x0008B127 per Ch21 manual");

static_assert(k_elc_pdbf2_addr == 0x0008B128U,
               "PDBF2 address must be 0x0008B128 per Ch21 manual");

static_assert(k_elc_pel0_addr == 0x0008B129U,
               "PEL0 address must be 0x0008B129 per Ch21 manual");

static_assert(k_elc_pel1_addr == 0x0008B12AU,
               "PEL1 address must be 0x0008B12A per Ch21 manual");

static_assert(k_elc_pel2_addr == 0x0008B12BU,
               "PEL2 address must be 0x0008B12B per Ch21 manual");

static_assert(k_elc_pel3_addr == 0x0008B12CU,
               "PEL3 address must be 0x0008B12C per Ch21 manual");

static_assert(k_elc_elsegr_addr == 0x0008B12DU,
               "ELSEGR address must be 0x0008B12D per Ch21 manual");

/* Verify bit definitions */
static_assert(k_elcr_elcon == 0x80U,
               "ELCR.ELCON must be bit 7");

static_assert(k_elc_mstpcrb_bit == (1U << 9U),
               "ELC module stop is MSTPCRB bit 9");
