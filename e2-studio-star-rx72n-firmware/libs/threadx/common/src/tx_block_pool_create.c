                           ...
                           ULONG          pool_size)
{
  ...
  block_size = (((block_size + (sizeof(ALIGN_TYPE))) - ((ALIGN_TYPE)1)) / (sizeof(ALIGN_TYPE))) *
               (sizeof(ALIGN_TYPE));
  ...
  if (blocks != ((UINT)0)) {
    ...
    *block_link_ptr = TX_NULL;
    ...
    TX_TRACE_OBJECT_REGISTER(TX_TRACE_OBJECT_TYPE_BLOCK_POOL,
                             pool_ptr,
                             name_ptr,
                             pool_size,
                             block_size)
    ...
    TX_TRACE_IN_LINE_INSERT(TX_TRACE_BLOCK_POOL_CREATE,
                            pool_ptr,
                            TX_POINTER_TO_ULONG_CONVERT(pool_start),
                            blocks,
                            block_size,
