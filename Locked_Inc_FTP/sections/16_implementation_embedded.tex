...
The ESP32 firmware implements a production-ready embedded framework called \textbf{STAR} (Sensor and Actuator Abstraction Runtime). This modular architecture follows SOLID principles to ensure loose coupling, testability, and maintainability across all subsystems.
