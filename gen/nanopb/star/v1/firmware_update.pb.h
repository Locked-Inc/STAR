...
#define star_v1_AbortUpdateResponse_size         (8 + star_v1_ResponseHeader_size)
#define star_v1_GetUpdateProgressResponse_size   (62 + star_v1_ResponseHeader_size)
#define star_v1_MarkValidResponse_size           (8 + star_v1_ResponseHeader_size)
#define star_v1_RebootResponse_size              (14 + star_v1_ResponseHeader_size)
#define star_v1_WriteChunkResponse_size          (64 + star_v1_ResponseHeader_size)
#endif
#if defined(star_v1_RequestHeader_size)
#define star_v1_FinalizeUpdateRequest_size       (6 + star_v1_RequestHeader_size)
#define star_v1_GetFirmwareInfoRequest_size      (6 + star_v1_RequestHeader_size)
#define star_v1_GetUpdateProgressRequest_size    (6 + star_v1_RequestHeader_size)
#define star_v1_MarkValidRequest_size            (6 + star_v1_RequestHeader_size)
#define star_v1_RebootRequest_size               (12 + star_v1_RequestHeader_size)
#define star_v1_RollbackRequest_size             (6 + star_v1_RequestHeader_size)
#define star_v1_StreamUpdateProgressRequest_size (12 + star_v1_RequestHeader_size)
#endif
