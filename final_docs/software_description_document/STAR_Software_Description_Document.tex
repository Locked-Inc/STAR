...
\begin{tabular}{r l}
Cesar Magana        & Software (proto, gateway, ROS2, UI, MATLAB) \\
Brighton Sikarskie  & Software (firmware, compliance engine, infra), Embedded Development, Schematic Design \\
...
peripheral and BeagleBone Blue bring-up targets are intentionally
...
\item STM32 peripheral firmware (covered in a separate hardware
      deliverable).
\item BeagleBone Blue bring-up and secondary compute work (retired
